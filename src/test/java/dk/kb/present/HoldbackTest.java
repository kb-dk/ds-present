...
public class HoldbackTest {
    ...
    public void getHoldbackDateFromXmlTest() throws IOException {
        ...
        assertEquals("2026-01-17T10:34:42+0100", HoldbackDatePicker.getInstance().getHoldbackDateForRecord(xml));
    }

    @Test
    public void holdbackNoValueTest() throws IOException {
        String xml = Resolver.resolveUTF8String(TestFiles.PVICA_RECORD_3006e2f8);
        assertEquals("9017-07-07T17:29:55+0000", HoldbackDatePicker.getInstance().getHoldbackDateForRecord(xml));
    }

    @Test
    public void holdbackNameNoValueTest() throws IOException {
        String xml = Resolver.resolveUTF8String(TestFiles.PVICA_RECORD_3006e2f8);
        assertTrue(HoldbackDatePicker.getInstance().getPurposeNameFromXml(xml).isEmpty());
    }

    @Test
    public void getHoldbackPurposeFromXmlTest() throws IOException {
        String xml = Resolver.resolveUTF8String(TestFiles.PVICA_DOMS_MIG_9ed10d66);
        assertEquals("Dansk Dramatik & Fiktion", HoldbackDatePicker.getInstance().getPurposeNameFromXml(xml));
    }
    ...
    public void getNoHoldbackDateFromXmlTest() throws IOException {
        ...
        assertEquals("9011-05-15T18:08:17+0100", HoldbackDatePicker.getInstance().getHoldbackDateForRecord(xml));
    }
