 ...
 * New transformers are added by creating an {@link dk.kb.present.transform.AbstractTransformer} with a corresponding
 * {@link dk.kb.present.transform.AbstractTransformerFactory} and registering the factory in the file
 * {@code src/main/resources/META-INF/services/dk.kb.present.transform.AbstractTransformerFactory}.
 *
